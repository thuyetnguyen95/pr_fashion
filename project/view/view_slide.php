<!-- <div id="slider" class="colum_left full_img">
    <img alt=""  src="./<?php echo isset($arr_slide['c_img'])?$arr_slide['c_img']:"";?>">
</div> -->
<div id="slider" class="colum_left full_img">
  <script type="text/javascript" src="./public/js/jssor.slider-21.1.5.min.js"></script>
    <script>
    ...
    <div id="jssor_22" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 640px; height: 314px; overflow: hidden; visibility: hidden;">
        <!-- Loading Screen -->
        ...
        <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 640px; height: 314px; overflow: hidden;">
            <?php 
                foreach ($arr_slide as $key) {
                    
            ?>
            <div style="display: none;">
              <img data-u="image" src="<?php echo isset($key["c_img"]) ? $key["c_img"]:"" ;?>" />
              <div class="slide_title" style="position: absolute; "><a ><?php echo $key["c_name"];?></a></div>
            </div>
            <?php 
                }
            ?>
